...
LANG[KEY].waiting_for_players = "EN ATTENDANT LES JOUEURS"
LANG[KEY].change_team_wait = "S'il vous plait, attendez %i secondes devant choisir un team."
LANG[KEY].you_will_spawn_as = "Vous serez spawn en tant %s."

LANG[KEY].select_team = "SÉLECTIONNER UNE ÉQUIPE"
LANG[KEY].team_slayer = "TUEUR"
LANG[KEY].team_vampire = "VAMPIRE"
LANG[KEY].auto_assign = "ALÉATOIRE"

LANG[KEY].select_class = "SÉLECTIONNER UNE PERSONNAGE"
LANG[KEY].class_random = "ALÉATOIRE"

LANG[KEY].vampires_win = "LES VAMPIRES GAGNENT"
LANG[KEY].slayers_win = "LES TUEURS GAGNENT"
LANG[KEY].round_draw = "JEU À ÉGALITÉ"

LANG[KEY].meter_faith = "FOI"
...
LANG[KEY].map_gm_construct_night_desc = [[This is a cool description of construct night.

Write a bit about why there are vampires here, or why they need to be slain.

Bleh.]]

LANG[KEY].map_de_chateau_name = "Chateau"
LANG[KEY].map_de_chateau_desc = [[This is a cool description of chateau.
